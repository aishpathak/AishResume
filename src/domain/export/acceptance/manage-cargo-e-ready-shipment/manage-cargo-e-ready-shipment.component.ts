...
@Component({
  selector: 'app-manage-cargo-e-ready-shipment',
  templateUrl: './manage-cargo-e-ready-shipment.component.html',
  styleUrls: ['./manage-cargo-e-ready-shipment.component.scss']
})
...
export class ManageCargoEReadyShipmentComponent extends NgcPage {
