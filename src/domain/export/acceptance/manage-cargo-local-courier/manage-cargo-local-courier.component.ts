...
@Component({
  selector: 'ngc-manage-cargo-local-courier',
  templateUrl: './manage-cargo-local-courier.component.html',
  styleUrls: ['./manage-cargo-local-courier.component.scss']
})

@PageConfiguration({
  trackInit: true
})
export class ManageCargoLocalCourierComponent extends NgcPage {
