...
export class RclserviceService {
  ...
  @TrackRestCallProgress()
  public process(request): Observable<any> {
    // return this.httpClient.process(this.jsonURL2);
    return <Observable<BaseResponse<any>>>this.restService.post
      (EXP_ENV.serviceBaseURL +
        EXP_ENV.process, request);
  }
  ...
  // For ExportawbdocumentComponent
  @TrackRestCallProgress()
  public fetchExportAwbDocumentDetails(request): Observable<any> {
    return <Observable<BaseResponse<any>>>this.restService.post
      (EXP_ENV.serviceBaseURL +
        EXP_ENV.fetchExportAwbDocumentDetails, request);
  }

  @TrackRestCallProgress()
  public saveExportAwbDocumentDetails(request): Observable<any> {
    return <Observable<BaseResponse<any>>>this.restService.post
      (EXP_ENV.serviceBaseURL +
        EXP_ENV.saveExportAwbDocumentDetails, request);
  }

  @TrackRestCallProgress()
  public confirmExportAwbDocumentDetails(request): Observable<any> {
    return <Observable<BaseResponse<any>>>this.restService.post
      (EXP_ENV.serviceBaseURL +
        EXP_ENV.confirmExportAwbDocumentDetails, request);
  }

  @TrackRestCallProgress()
  public unConfirmExportAwbDocumentDetails(request): Observable<any> {
    return <Observable<BaseResponse<any>>>this.restService.post
      (EXP_ENV.serviceBaseURL +
        EXP_ENV.unConfirmExportAwbDocumentDetails, request);
  }
