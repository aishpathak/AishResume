...
import { NgcPage, NgcFormGroup, NgcFormArray, NgcFormControl, NgcButtonComponent, PageConfiguration, NgcReportComponent, ReportFormat, NgcWindowComponent } from 'ngc-framework';
...
export class UldInventoryDetailsComponent extends NgcPage implements OnInit {
  ...
  public getUldList() {
    ...
    // //   this.uldEnquireObject.parameter1 = event.record.uldNumber;
